...
// Socket is a reference to a WebSocket endpoint requiring authentication.
type Socket struct {
...
const file_socket_proto_rawDesc = "" +
	"\n" +
	"\fsocket.proto\x12\x0fanyserver.files\"2\n" +
	"\x06Socket\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12\x14\n" +
	"\x05token\x18\x02 \x01(\tR\x05tokenB6Z4github.com/accretional/anyserver/proto/files;filespbb\x06proto3"
...
var file_socket_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_socket_proto_goTypes = []any{
	(*Socket)(nil), // 0: anyserver.files.Socket
}
