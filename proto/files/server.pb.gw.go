...
func request_Files_Get_0(ctx context.Context, marshaler runtime.Marshaler, client FilesClient, req *http.Request, pathParams map[string]string) (Files_GetClient, runtime.ServerMetadata, error) {
	var (
		protoReq GetRequest
...
func RegisterFilesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FilesServer) error {
	mux.Handle(http.MethodGet, pattern_Files_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
...
// "FilesClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterFilesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FilesClient) error {
	mux.Handle(http.MethodGet, pattern_Files_Get_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/anyserver.files.Files/Get", runtime.WithHTTPPathPattern("/files/{path=**}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Files_Get_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
		}
		forward_Files_Get_0(annotatedContext, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
	})
	return nil
}

var (
	pattern_Files_Get_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 3, 0, 4, 1, 5, 1}, []string{"files", "path"}, ""))
)

var (
	forward_Files_Get_0 = runtime.ForwardResponseStream
)
